...
func TestGetEntries(t *testing.T) {
	...
	tt := []struct {
		name                           string
		getCountriesLeaderboardEntries func(table string, filterParams models.GetEntriesFilterParams) ([]repo.LeaderboardEntryDto, error)
	...
	}{
		{
			...
			getCountriesLeaderboardEntries: repo.GetLeaderboardEntries,
	...
	for _, tc := range tt {
		t.Run(tc.name, func(t *testing.T) {
			repo.GetLeaderboardEntries = tc.getCountriesLeaderboardEntries
